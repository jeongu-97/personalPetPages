import svgPaths from "./svg-zntgdskyx0";
...
function LowMovementZIndex() {
  return (
    ...
    >
      <div
        className="[background-size:151.13%_100%] absolute bg-no-repeat bg-top h-[156px] left-[181px] top-[230px] w-[154.819px]"
        data-name="Item 02"
...
function HighMovementZIndex() {
  return (
    ...
    >
      ...
      />
      <div
        className="[background-size:608.21%_321.13%] absolute bg-[14%_78.33%] bg-no-repeat h-[285px] left-[-45px] top-56 w-[218.877px]"
        data-name="Item 03"
        style={{ backgroundImage: `url('${imgItem413}')` }}
      />
      <div
...
function Frame2147241477() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col grow items-center justify-between min-h-px min-w-px p-0 relative shrink-0">
      <TitleContainer />
      <ButtonContainer />
      <HighMovementZIndex />
    </div>
